...
namespace Math
{
    ...
    class D3D12PLAYGROUNDCOMMON_API OrthogonalTransform
    {
    public:
        ...
        { 
            return Vector4(SetWToZero(m_rotation * Vector3((XMVECTOR)vec))) +
    ...
    //
    class D3D12PLAYGROUNDCOMMON_API ScaleAndTranslation
    {
    public:
    ...
    // 
    class D3D12PLAYGROUNDCOMMON_API UniformTransform
    {
    public:
    ...
    class D3D12PLAYGROUNDCOMMON_API AffineTransform
    {
    public:
