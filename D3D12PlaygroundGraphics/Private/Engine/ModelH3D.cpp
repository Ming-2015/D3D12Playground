...
bool ModelH3D::LoadH3D(const wstring& filename)
{
    ...
    Byte* uploadMem = (Byte*)geomBuffer.Map();
    ...
    m_pVertexData = new Byte[m_Header.vertexDataByteSize];
    m_pIndexData = new Byte[m_Header.indexDataByteSize];
    m_pVertexDataDepth = new Byte[m_Header.vertexDataByteSizeDepth];
    m_pIndexDataDepth = new Byte[m_Header.indexDataByteSize];
